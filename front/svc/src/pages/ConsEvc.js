...
const ConsEvcGrid = (props) => {
    ...
    const columns = [
        ...
        { field: 'response_time', headerName: 'Response Time', width: 120, type: Number, align: 'center', },
        { field: 'stat_days', headerName: 'STAT Days', width: 130, align:'right', },
        { field: 'stat_hours', headerName: 'STAT Hours', width: 100, type: Number, align: 'right', },
        ...
        { field: 'visit_date', headerName: 'Visit Date', width: 180, type: 'dateTime', valueGetter: (value) => value && new Date(value), },
        { field: 'work_done', headerName: 'Work Done', width: 300, },
        { field: 'case_visit_dt', headerName: 'Case Visit Dt', width: 180, type: 'dateTime', valueGetter: (value) => value && new Date(value), },
        { field: 'check_out', headerName: 'Check Out', width: 180, type: 'dateTime', valueGetter: (value) => value && new Date(value), },
        ...
        { field: 'symptom_desc', headerName: 'Symptom Desc', width: 250, },
        ...
        { field: 'case_tech', headerName: 'Case Technician', width: 180, },
        ...
        { field: 'visit_dt', headerName: 'Visit Dt', width: 180, type: 'dateTime', valueGetter: (value) => value && new Date(value), },
    ...
    return (
        <Box sx={{ width: '100%' }}>
            ...
            <Box sx={{ height: '77vh', width: '78vw', m: 1, mt: 2}}>
                <ConsEvcGrid frDate={frDate} toDate={toDate} search={search} />
            </Box>
        </Box>
    );
}

export default ConsEvc;